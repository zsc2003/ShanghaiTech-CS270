...
\title{	Digital Image Processing, 2024 Spring\\Homework 1}
\date{Due 23:59 (CST), Apr. 7, 2024 }
...
histogram of CLAHE processed image
...
\begin{figure}[htbp]
    \centering
	\includegraphics[width=0.8\textwidth]{../images/grain.jpg}
    \caption{testing}
    \label{fig:1}
\end{figure}
