...
\begin{figure}[h]
        ...
        \centering
        \includegraphics[height=5cm]{../origin_images/grain.tif}
        \end{minipage}
        \begin{minipage}[t]{0.4\textwidth}
        \centering
        \includegraphics[height=5cm]{../origin_images/tire.tif}
...
\begin{center}
    \includegraphics[height=5.5cm]{../origin_images/lena_noisy.tif}
\end{center}
